...
with np.load("../../sqrt-parallel-smoothers-pushing/tests/iterated_res_mean.npz") as loaded:
    mean, expected_mean, cov, expected_cov = loaded["mean"], loaded["expected_mean"], loaded["cov"], loaded["expected_cov"]

with np.load("../../sqrt-parallel-smoothers-pushing/tests/iterated_res_mean_new.npz") as loaded:
